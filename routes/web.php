...
// load quiz mcq question
Route::post('getMCQ/{q}' , 'Site\QuestionController@getMCQ');

//Mark mcq answer
Route::post('mark-mcq-answer','Site\QuestionController@markMCQ');

// load crossword puzzle question 
Route::post('getPuzzle' , 'Site\QuestionController@getPuzzle');

// mark crossword puzzle question 
Route::post('markPuzzle' , 'Site\QuestionController@markPuzzle');

// load presentation question 
Route::post('getPresentation' , 'Site\QuestionController@getPresentation');
...
// Admin quiz routes
Route::resources(['admin/quizes' => 'Admin\QuizController']);
Route::post('admin/quiz-create' , 'Admin\QuizController@create')->name('admin/quiz-create');
Route::post('admin/quiz-update' , 'Admin\QuizController@update')->name('admin/quiz-update');
// Admin puzzle routes
Route::resources(['admin/puzzles' => 'Admin\PuzzleController']);
Route::post('admin/puzzle-create' , 'Admin\PuzzleController@create')->name('admin/puzzle-create');
Route::post('admin/puzzle-update' , 'Admin\PuzzleController@update')->name('admin/puzzle-update');
...
// Authentication Routes...
$this->get('admin', 'Admin\Auth\AdminLoginController@showLoginForm');
