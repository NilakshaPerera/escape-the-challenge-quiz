...
class QuestionController extends Controller {
     ...
     * Summary : Loads the quiz start blade
     *
     * @return void
     */
     ...
     * Created By : Nilaksha
     * Created At : 25-4-2019
     * Summary : Gets the MCQ based on the current logged in candidate
     *
     * @param [type] $q
     * @return void
     */
     ...
     * Created By : Nilaksha
     * Created At : 25-4-2019
     * Summary : Mark the answer for a puzzle 
     * 
     * @param Request $request
     */
     ...
     * Created By : Nilaksha
     * Created At : 25-4-2019
     * Summary : Retrieves the presentation for the logged in user
     *
     * @param Request $request
     * @return void
     */
     ...
     * Summary : Gets current un ended session for a particular logged in user 
     *
     * @param Request $request
     * @return void
     */
