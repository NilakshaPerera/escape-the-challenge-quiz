...
<div class="col-md-12 col-sm-12 col-xs-12">    
    <div class="x_panel">
        <div class="x_title">
            <h2>Update Qs and As <small>Update the questions and answers.</small></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <form id="formadduser" name="formadduser" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('admin/quiz-update') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="{{ $data['question']->title }}" id="txttitle" name="txttitle" required="required" value="" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="txtquestion" name="txtquestion" required value="" class="form-control col-md-7 col-xs-12"> {!! $data['question']->question  !!}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div id="dynamic-answer-container" name="dynamic-answer-container" class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php   
                        $answers = json_decode( $data['question']->answers , true);
                        ...
                        <div id="" name="" class="dynamic-answer" >
                            ...
                            <div class="col-md-1 col-sm-1 col-xs-1"  style="margin-bottom: 5px;">  
                                <input onclick="clone($(this) , 'dynamic-answer' , 'dynamic-answer-container')" class="btn-add-question btn" type="button" value="+">
                            </div>
                            <div class="col-md-1 col-sm-1 col-xs-1"  style="margin-bottom: 5px;">  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="{{ $data['question']->answer }}" type="number" id="txtanswer" name="txtanswer" max="5" min="1" required class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                ...
                <input id="hash" name="hash" type="hidden" value="{{ $data['question']->id }}">
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <button onclick="window.location = '{{url('/admin/quizes')}}'" class="btn btn-primary" type="button">Back</button>
