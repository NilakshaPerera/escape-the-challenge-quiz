...
<div class="col-md-12 col-sm-12 col-xs-12">    
    <div class="x_panel">
        ...
        <div class="x_content">
            <form id="formaddquestion" name="formaddquestion" enctype='multipart/form-data' data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('admin/presentation-create') }}">
                @csrf
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txtname"> Video <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="filevid" name="filevid" required class="form-control col-md-7 col-xs-12">
                    </div>
                </div>                   
                    ...
                    <tbody>
                        ...
                        foreach (App\Presentation::get() as $presentation){
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="last">
                                    <a href="{{ action('Admin\PresentationController@edit', $presentation->id ) }}">
