...
<div class="col-md-12 col-sm-12 col-xs-12">    
    <div class="x_panel">
        <div class="x_title">
            <h2>Puzzle <small>Upload new Puzzles.</small></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <form id="formaddquestion" name="formaddquestion" enctype='multipart/form-data' data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('admin/puzzle-create') }}">
                @csrf
                ...
                <?php } ?>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="txtname"> Puzzle Title <span class="required">*</span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <div id="dynamic-answer-container-d" name="dynamic-answer-container-d" class="col-md-6 col-sm-6 col-xs-12">
                        <div id="" name="" class="dynamic-answer-d" >
                            <div class="col-md-10 col-sm-10 col-xs-11" style="margin-bottom: 5px; padding-left: 0">   
                                <input name="txtanswers_d[]" required class="form-control col-md-7 col-xs-7"> 
                            </div>
                            <div class="col-md-1 col-sm-1 col-xs-1"  style="margin-bottom: 5px;">  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="filepuzzle" name="filepuzzle" required class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                ...
                <table id="jstable" name="jstable" class="table table-striped table-bordered dt-responsive nowrap">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title" style="display: table-cell;">Puzzle Title</th>
                            <th class="column-title" style="display: table-cell;">Puzzle File</th>
                    ...
                    <tbody>
                        <?php
                        foreach (App\Puzzle::get() as $question) {
                            ?>
                            <tr class="even pointer">
                                <td class=""><?php echo $question->id ?></td>
                                <td class=""><?php echo $question->created_at->format('Y-m-d') ?></td>
                                <td class=""><?php echo $question->name ?></td>
                                <td class=""><a target="_blank" href="{{ url($question->file) }}">File</a></td>
                                <td class="last">
                                    <a href="{{ action('Admin\PuzzleController@edit', $question->id ) }}">
