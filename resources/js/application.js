        ...
        $.ajax({
            ...
            success: function (respond) {
                if (respond.success) {
                    ...
                    window.localStorage.setItem('mcq', JSON.stringify(respond.data['mcq']));
                    window.localStorage.setItem('puzzle', JSON.stringify(respond.data['presentation']));
                    window.localStorage.setItem('presentation', JSON.stringify(respond.data['puzzle']));
                    /*
                    var d = new Date();
